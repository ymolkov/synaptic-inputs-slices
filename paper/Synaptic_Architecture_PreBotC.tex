...
Classical models (e.g., \citep{smith2007spatial,rubin2009multiple}) of how the preBötC operates and interacts with other circuits when the preBötC is embedded in the ventral respiratory column describe a hierarchical organization in which the preBötC is sufficient to generate a basic inspiratory rhythm via an excitatory interneuron kernel, including pre-I spiking neurons, with the preBötC inhibitory inspiratory neurons functioning to suppress expiratory activity and coordinate inspiratory-expiratory phase transitions. In this scheme, the full three-phase respiratory pattern characteristic of the intact brainstem respiratory network with (pre)inspiratory, post-inspiratory (post-I), and late (aug-E) expiratory activity phases, depends on additional inhibitory populations, including post-I and aug-E neurons, recruited from the rostral Bötzinger Complex (BötC). The previous large-scale computational models have posited that the respiratory rhythm relies on a "mutually inhibitory ring" structure involving interactions between the preBötC and BötC inhibitory circuits \citep{smith2007spatial,rubin2009multiple,molkov2017computational}. Specifically, these models suggest that the phase transitions are orchestrated by reciprocal inhibitory circuit interactions between preBötC inspiratory (Early-I) and BötC expiratory (Post-I and Aug-E) inhibitory neuron populations. For a more detailed comparison of the connectome of these previous models and the elaborated current connectome schematics for in situ conditions derived from our in situ conductance analyses, see \figpanelref{fig:preserved-core-circuitry}{B} and Supplemental Figure 1 in \citep{molkov2024inference}.

More recent experimental and modeling studies, however, have pointed to a more elaborate inhibitory connectome within the preBötC, incorporating post-I inhibitory neurons in addition to inspiratory inhibitory neurons and their synaptic interactions, not explicitly depicted in those earlier models. Indeed, our recent in situ recordings \citep{molkov2024inference} identified substantial numbers of both post-I and aug-E neurons, including glycinergic inhibitory subtypes within the preBötC itself, consistent with earlier recording studies of preBötC neuron activity (e.g., \citep{schwarzacher1995prebotzinger}) in vivo. Furthermore, there are more diverse patterns of inspiratory activity and associated synaptic conductance profiles. The neurons that we identified in situ have multiphasic patterns of synaptic interactions consistent with three-phase pattern generation. Thus, there are neurons within the preBötC, including inhibitory neurons, that can generate different patterns of inspiratory-expiratory activity and the full three-phase activity pattern with the diversity of neuronal firing phenotypes, but these neurons are not fully engaged under the conditions of neuronal excitability in the isolated rhythmically active medullary slice where neuronal activity patterns are clearly transformed.

Our conductance-based analysis and circuit reconstruction for the preBötC in the slice (\figrefs{fig:circuit-connectivity}{fig:preserved-core-circuitry}), viewed together with our in situ functional circuit reconstruction \citep{molkov2024inference} (\figref{fig:preserved-core-circuitry}), suggests one plausible interpretation for the connectivity of the active circuits in vitro: the isolated preBötC already contains core circuits with connectivity including the inhibitory connectome for generating inspiratory and expiratory activity patterns, with some connectivity features (motifs) paralleling those of the intact active network. These retained motifs include excitatory and inhibitory populations for each firing phenotype (pre)I and E, and the reciprocal interactions between I and E inhibitory neurons.

How can we more specifically relate the in vitro and in situ functional connectomes depicted in \figpanelref{fig:preserved-core-circuitry}{A} and \figpanelref{fig:preserved-core-circuitry}{C}? One plausible interpretation of the modest inhibitory conductances attributed (\figref{fig:high-resolution-conductances}) to self-inhibition (VGAT-I \(\approx\) 0.167 during inspiration; VGAT-E \(\approx\) 0.073 during expiration) is that they reflect weak cross-inhibition within temporally offset neuronal subsets rather than actual self-inhibition (\figpanelref{fig:preserved-core-circuitry}{B}). Under this view, the VGAT-I population can be resolved into pre-I/I and early-I inhibitory subsets with moderate reciprocal interactions, whereas the VGAT-E population can be resolved into post-I and aug-E inhibitory subsets which become active and coordinated when the preBötC is embedded in the ventral respiratory column in situ/in vivo. Although inferential, this mapping highlights the possibility of clear population-level parallels between the slice-derived circuit and the classic functional neuronal classes and their connectivity inferred for the circuits active in situ.

This interpretation is also consistent with the neuronal firing patterns and synaptic conductance profiles in the preBötC operating in the intact ventral respiratory column. Earlier models (e.g., \citep{smith2007spatial}) placed post-I and aug-E populations primarily in the more rostral BötC circuits for expiratory pattern generation. However, our analysis of synaptic conductance profiles shows that the active preBötC post-I and aug-E neurons in situ have the same profiles as their BötC counterparts. We currently do not know if the preBötC circuits can intrinsically generate these expiratory patterns under the appropriate excitability conditions without external inputs, or that inputs including from the BötC are required to interact with specific subsets of preBötC expiratory neurons. We do know that when the preBötC and BötC are operating together without pontine inputs in situ, their interacting circuits only generate a two-phase inspiratory-expiratory rhythmic pattern \citep{smith2007spatial}. Thus, while the BötC circuits are clearly connected to preBötC circuits, including inhibitory circuit interactions \citep{ausborn2018organization}, generally required for three-phase pattern generation \citep{richter2014respiratory,marchenko2016perturbations}, the BötC circuits are not the exclusive source of these patterns although important for elaborating them as observed in situ (\figpanelref{fig:preserved-core-circuitry}{C}). Of relevance, we note that pharmacological disruption of synaptic inhibition in the preBötC in situ disrupts the three-phase respiratory pattern with large disturbances of the rhythm \citep{marchenko2016perturbations}, and likewise disruption of inhibition in the BötC disrupts this pattern and perturbs the rhythm. Apparently the interactions of preBötC and BötC circuits are mutually reinforcing in generating the three-phase rhythmic pattern. As noted earlier, disrupting synaptic inhibition in the preBötC in vitro does not disrupt rhythm generation. From this perspective, the slice preserves a compact core inhibitory circuit motif (\figpanelref{fig:preserved-core-circuitry}{A}) while lacking the extended circuitry with a more complex inhibitory and excitatory connectome normally required for three-phase pattern generation.

This framework outlined in \figref{fig:preserved-core-circuitry} is further supported by the analogous pre-inspiratory dynamics  (\suppfigrange{fig:supp4}{fig:supp5}). In particular, the inhibitory pre-I/I population, present in both in situ and in vitro (\suppfigref{fig:supp4}), may represent an underappreciated but functionally important component of preBötC circuits. Earlier computational models \citep{smith2007spatial,ausborn2018organization,butera1999bursting} typically emphasized inspiratory phase switching mechanisms involving pre-I excitatory drive (inspiratory on-switching) and post-I inhibition (off-switching). The inhibitory pre-I/I population may also be involved by contributing to expiratory phase termination and to temporal structuring within the inspiratory inhibitory population.

Viewed in this way, the slice isolates a compact and functionally reduced version of the in situ network. We hypothesize this functional reduction---specifically, the collapse from a three-phase rhythm to a simplified binary two-phase alternating rhythm---is due to the loss of tonic excitatory drive (e.g., from pontine and retrotrapezoid nuclei) in the isolated preparation and interactions with BötC circuits. In the intact network, higher baseline excitability combined with intrinsic neuronal spike-frequency adaptation properties allows these embedded subpopulations to sequentially activate, driving multiphasic transitions. Without this external drive, the reduced excitability in the slice limits these transitions, leaving the rhythm to be driven by the preBötC’s intrinsic excitatory neuron population rhythmogenic properties, but structured into a binary alternating pattern by the preserved inhibitory half-center. Therefore, the principal contribution of the external excitatory and BötC inputs may be not to introduce qualitatively new circuit motifs, but to expand an already present preBötC circuit into a richer multiphasic inhibitory sequence and expiratory activity patterns. The isolated preBötC would therefore retains core half-center organization together with pre-I/I excitatory--inhibitory coordination, while lacking the more complex sets of inhibitory and excitatory interactions present in the intact network.
